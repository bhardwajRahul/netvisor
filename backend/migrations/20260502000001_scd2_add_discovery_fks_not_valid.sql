...
ALTER TABLE hosts
    ADD CONSTRAINT hosts_last_discovery_fk
        FOREIGN KEY (last_discovery_id) REFERENCES discoveries(id) ON DELETE SET NULL NOT VALID,
    ADD CONSTRAINT hosts_first_discovery_fk
        FOREIGN KEY (first_discovery_id) REFERENCES discoveries(id) ON DELETE SET NULL NOT VALID;
...
ALTER TABLE subnet_vlans
    ADD CONSTRAINT subnet_vlans_last_discovery_fk
        FOREIGN KEY (last_discovery_id) REFERENCES discoveries(id) ON DELETE SET NULL NOT VALID,
    ADD CONSTRAINT subnet_vlans_first_discovery_fk
        FOREIGN KEY (first_discovery_id) REFERENCES discoveries(id) ON DELETE SET NULL NOT VALID;
