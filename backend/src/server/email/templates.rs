...
pub const PAYMENT_METHOD_REMOVED_TITLE: &str = "Payment Method Removed - Scanopy";

pub const PAYMENT_METHOD_REMOVED_BODY: &str = r#"                    <!-- Main Content -->
                    <tr>
                        <td style="padding: 0 40px 20px 40px;">
                            <h1 style="margin: 0 0 20px 0; font-size: 24px; font-weight: 600; color: #1a1a1a; text-align: center;">Payment Method Removed</h1>
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #4a4a4a;">Hi there,</p>
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #4a4a4a;">A payment method has been removed from your Scanopy account.</p>
                            <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #4a4a4a;">If this wasn't you, sign in to your account, add a payment method back, and review your active sessions in Settings.</p>
                        </td>
                    </tr>
...
pub const PAYMENT_RECOVERED_TITLE: &str = "Your Scanopy Payment is Back On Track";

pub const PAYMENT_RECOVERED_BODY: &str = r#"                    <!-- Main Content -->
                    <tr>
                        <td style="padding: 0 40px 20px 40px;">
...
pub const CANCELLATION_INITIATED_TITLE: &str = "Your Scanopy Subscription Will End on {period_end}";

pub const CANCELLATION_INITIATED_BODY: &str = r#"                    <!-- Main Content -->
                    <tr>
                        <td style="padding: 0 40px 20px 40px;">
...
pub const CHECKOUT_COMPLETED_TITLE: &str = "Welcome to Scanopy {plan_name}";

pub const CHECKOUT_COMPLETED_BODY: &str = r#"                    <!-- Main Content -->
                    <tr>
                        <td style="padding: 0 40px 20px 40px;">
