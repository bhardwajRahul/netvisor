...
# SNMP Test Environment — manages 14 snmpd instances on a Proxmox LXC
# Subnet: 192.168.4.0/22 (hosts at 192.168.7.230–243)
...
COMMUNITIES=(netdefault netdefault secret42 secret42 public netdefault legacyv1 - netdefault netdefault netdefault netdefault public netdefault)
SYSNAMES=("switch-core-01" "switch-access-01" "router-gw-01" "firewall-01" "printer-lobby" "ap-wireless-01" "legacy-switch-01" "secure-switch-01" "switch-exos-01" "switch-voss-01" "switch-netgear-01" "switch-aruba-01" "switch" "switch-flaky-01")
